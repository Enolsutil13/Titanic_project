...
def load_data(): #function to load data
    df = pd.read_csv(r'C:\Users\leo21\Desktop\Upgrade_hub\modulo1\proyecto_titanic\clean_titanic.csv') 
    df_clean = df.copy()
    return df_clean
...
st.sidebar.image(r"C:\Users\leo21\Desktop\Upgrade_hub\modulo1\proyecto_titanic\tema-ilustracion-iceberg.png", width=150)
...
def show_landing(): #function to show landing section
    ...
    st.image(r'C:\Users\leo21\Desktop\Upgrade_hub\modulo1\proyecto_titanic\k-mitch-hodge-y-9-X5-4-vU-unsplash.jpg', caption = 'Credits: K. Mitch Hodge via Unsplash')
    ...
    with st.expander("Route map"):
        ...
        st.image(r'C:\Users\leo21\Desktop\Upgrade_hub\modulo1\proyecto_titanic\AdobeStock_322554404.jpeg', caption='Adobe Stock')
